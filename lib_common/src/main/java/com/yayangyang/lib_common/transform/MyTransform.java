package com.yayangyang.lib_common.transform;
...
public class MyTransform extends BitmapTransformation {
    ...
    public MyTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public MyTransform(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    @Override protected Bitmap transform(@NonNull Context context, @NonNull BitmapPool pool,
        ...
        LogUtils.e("transform-toTransform"+toTransform.getConfig());
        Bitmap bitmap = pool.get(width, height, Bitmap.Config.ARGB_8888);//这里为RGB_565会画出黑角
...
//        LogUtils.e("transform-width"+width);
//        LogUtils.e("transform-height"+height);
