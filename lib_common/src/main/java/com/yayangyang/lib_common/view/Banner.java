...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.my_banner;
    ...
    private MyExtendViewPager viewPager;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        viewPager = (MyExtendViewPager) view.findViewById(R.id.bannerViewPager);
...
//                Log.e(tag, "curr+++++++++:" + currentItem + " count:" + count);
...
//        LogUtils.e("onPageScrollStateChanged-currentItem: "+currentItem);
...
//                    LogUtils.e("onPageScrollStateChanged-wwwwwwwwwwwwwwww");
